...
activities = st.text_input("Any specific activities or preferences?")

# Generate conversation button
if st.button("Start Planning"):
    if destination and days and budget and interests and travel_style and activities:
        with st.spinner('Planning your trip...'):
            conversation = generate_itinerary(destination, days, budget, interests, travel_style, activities)
